  ...
  <div class="hotspots">
    ...
    <el-container class="hotspot-pie">
      ...
      <el-main class="conenthotpottj" style="padding:0">
        <div id="hotspotPiessd" style="overflow: hidden;" v-if="hasdata"></div>
...
export default {
  ...
  methods: {
    ...
    getTjdata(row){
      ...
      this.getpieData(row)
      this.getgridTypeListData(row)

    },
    //获取热点网格的企业类型数据
    getgridTypeListData(par) {
      let me = this;
    ...
    pieEcharts(chartData) {
      let chart1 = document.getElementById("hotspotPiessd");
    ...
    zhuEcharts(seriesData) {
      ...
      this.mychart3 = this.$echarts.init(chartzhe, "light");
      var xData = [],
        yData = [];
