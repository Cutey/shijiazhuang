<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" style="display: flex;align-items: center;">
      ...
      <el-form-item label="行政区划代码" prop="areaId">
         <el-input
    ...
    <el-table v-loading="loading" :data="postList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="测站名称" align="center" prop="pointName" />
      <el-table-column label="经度" align="center" prop="longitude" />
      <el-table-column label="纬度" align="center" prop="latitude" />
      <el-table-column label="纬度" align="center" prop="latitude" />
      <el-table-column label="行政区划代码" align="center" prop="areaId" />
      <el-table-column label="类型" align="center" prop="levels" />
    </el-table>
...
<script>
import {getDPmPoint,deleteDPmPoint,insertDPmPoint,updateDPmPoint} from '@/api/zygl/czgl'
export default {
  data() {
    return {
      // 遮罩层
