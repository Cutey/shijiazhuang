<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" style="display: flex;align-items: center;">
      ...
      <el-form-item label="站点类型" prop="levels">
         <el-input
    ...
    <el-table v-loading="loading" :data="postList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
        <el-table-column label="站点名称" align="center" prop="pointName" />
      <el-table-column label="站点ID" align="center" prop="pointId" />
      <el-table-column label="行政区" align="center" prop="areaName" />
      <el-table-column label="行政区划代码" align="center" prop="areaId" />
       <el-table-column label="站点类型" align="center" prop="levels" />
...
<script>
import {getDPmPoint,deleteDPmPoint,insertDPmPoint,updateDPmPoint} from '@/api/zygl/zqwzdgl'
export default {
  data() {
    return {
      // 遮罩层
