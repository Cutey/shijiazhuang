...
<script>
import { listRole, getRole, delRole, addRole, updateRole, exportRole, dataScope, changeRoleStatus ,ImportSavaData} from "@/api/system/role";
    ...
    return {
      ...
      upload: {
        ...
        url:
          ...
          "/system/CurrencyAnalysisFile/importData",
        //上传传的参数
        data: {
          type: "roleFile"
        }
      ...
      contrastrules: {
        ...
        roleId: [
          { required: true, message: "roleId不能为空", trigger: "blur" }
        ]
      },
      // 表单校验
      rules: {
